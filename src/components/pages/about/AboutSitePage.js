...
import './css/AboutSitePage.css'

function AboutSitePage() {

  const AboutSiteTitle = () => {
    return (
      <div className="about_site_page_title_container">
        <div className="about_site_page_title">
           &#128187; About Site
        </div>
        <div className="about_site_page_subtitle">
